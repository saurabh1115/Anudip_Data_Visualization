...
# search the index of a value after sorting the array
search = np.searchsorted(a,4)
print(search)

# split array in sub arrays
a = np.array([1,2,3,4,5])
sub_array = np.split(a,[2,4])
for sub_arr in sub_array:
    print(sub_arr)

# sorted ascending and descending 1-D array
arr = np.array([1,2,3,4,5])
sorted_arr = np.sort(arr)
print("sorted asceding array",sorted_arr)
sorted_arr_desc = np.sort(arr)[::-1]
print("sorted descending array",sorted_arr_desc)

# sorted ascending and descending 2-D array
matrix = np.array([[1,2,3],[4,5,6]])
sorted_matrex = np.sort(matrix, axis=1)
print("sorted ascending matrix : ",sorted_matrex)

# concatination of two 2-D arrays
...
# variance 
prd_a = np.array([85, 88, 90, 92, 95])
prd_b= np.array([70, 80, 85, 95, 100])
...
# find median through percentile method 
